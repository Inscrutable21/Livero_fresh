...
class ProductDetailScreen extends StatelessWidget {
      ...
      child: Stack(children: [
        Column(children: [
          Expanded(child: ListView(children: [
            Stack(children: [
              Container(height: 300, color: p.color, child: Center(child: Icon(p.icon, size: 110, color: app.accent.withValues(alpha: .35)))),
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  Text('₹$price', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: Color(0xFF12261C))),
                  const SizedBox(width: 9),
                  Text('₹$mrp', style: const TextStyle(fontSize: 13, color: Color(0x6B12261C), decoration: TextDecoration.lineThrough)),
                  const SizedBox(width: 9),
                  Text('${p.off}% off', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w600, color: app.accent)),
                ]),
                ...
                Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: const Color(0xFFF2F8F4), borderRadius: BorderRadius.circular(14)), child: Row(children: [
                  ...
                  const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Delivered in 9 minutes', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF12261C))),
                    Text('From Kondhwa dark store · free over ₹199', style: TextStyle(fontSize: 10.5, color: Color(0x8012261C))),
                  ])),
                ])),
        ...
        Positioned(left: 0, right: 0, bottom: 0, child: Container(
          ...
          decoration: BoxDecoration(gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.white.withValues(alpha: 0), Colors.white]), color: Colors.white),
          child: SafeArea(top: false, child: Row(children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('₹$price', style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Color(0xFF12261C))),
            ...
            Expanded(child: GestureDetector(
              ...
              child: Container(height: 52, decoration: BoxDecoration(borderRadius: BorderRadius.circular(16), gradient: const LinearGradient(colors: [Color(0xFF0A5C39), Color(0xFF12A05F)]), boxShadow: const [BoxShadow(color: Color(0x520A5C39), blurRadius: 22, offset: Offset(0, 8))]), alignment: Alignment.center, child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                const SizedBox(width: 8),
                Text(qty > 0 ? 'In basket · $qty  |  Add more' : 'Add to basket', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white)),
              ])),
            )),
          ])),
        )),
  ...
  static Widget _roundBtn(IconData icon) => Container(width: 36, height: 36, decoration: BoxDecoration(color: Colors.white.withValues(alpha: .92), borderRadius: BorderRadius.circular(12), boxShadow: const [BoxShadow(color: Color(0x1F122612), blurRadius: 8, offset: Offset(0, 2))]), child: Icon(icon, size: 17, color: const Color(0xFF12261C)));
  ...
  Widget _packOption(AppState app, int i, String label, int price) {
    ...
    return Expanded(child: GestureDetector(
      ...
      child: Container(padding: const EdgeInsets.symmetric(vertical: 10), decoration: BoxDecoration(color: on ? const Color(0xFFEAF6EF) : Colors.white, border: Border.all(color: on ? app.accent : const Color(0x1F122612), width: 1.4), borderRadius: BorderRadius.circular(12)), child: Column(children: [
        ...
        Text('₹$price', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: on ? const Color(0xFF0A5C39) : const Color(0xA6122612))),
      ])),
    ));
  }
